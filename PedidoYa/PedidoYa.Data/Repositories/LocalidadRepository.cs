...
namespace PedidoYa.Data.Repositories
{
    public class LocalidadRepository : ILocalidadRepository
    {
        ...
        public async Task<IEnumerable<Localidad>> GetAllLocalidad()
        {
            ...
            var sql = @"SELECT idlocalidad, nombre FROM localidad";
        ...
        public async Task<bool> InsertLocalidad(Localidad localidad)
        {
            ...
            var sql = @"INSERT INTO localidad (nombre) VALUES (@Nombre)";

            var result = await db.ExecuteAsync(sql, new { localidad.nombre});
            return result > 0;
        }
        ...
        public async Task<bool> UpdatetLocalidad(Localidad localidad)
        {
            ...
            var result = await db.ExecuteAsync(sql, new { localidad.idLocalidad, localidad.nombre});
            return result > 0;
        }
    }
}
